package com.unir.webdev.books.infrastructur.utils;
...
public class StartData {
    ...
    public void persistDataAfterStart() {
        bookRepositoryJPA.saveAll(
                List.of(
                        new BookEntity(
                                UUID.randomUUID(),
                                new BookName("Cien años de soledad"),
                                new Isbn("978-0307474728"),
                                new Image("https://images-na.ssl-images-amazon.com/images/I/51ct4ckpvDL.jpg"),
                        ...
                        new BookEntity(
                                ...
                                new Image("https://images-na.ssl-images-amazon.com/images/I/41K7ymN5P7L.jpg"),
                        ...
                        new BookEntity(
                                ...
                                new Image("https://images-na.ssl-images-amazon.com/images/I/51YGcM9n8DL.jpg"),
                        ...
                        new BookEntity(
                                ...
                                new Image("https://images-na.ssl-images-amazon.com/images/I/81gepf1e0lL.jpg"),
                        ...
                        new BookEntity(
                                ...
                                new Image("https://images-na.ssl-images-amazon.com/images/I/51EstVXM1tL.jpg"),
                        ...
                        new BookEntity(
                                ...
                                new Image("https://images-na.ssl-images-amazon.com/images/I/81bR4c6y5-L.jpg"),

...
public class StartData {
    ...
    public void persistDataAfterStart() {
        bookRepositoryJPA.saveAll(List.of(new BookEntity(UUID.randomUUID(),
                                                         ...
                                                         new Image("https://images-na" +
                                                                   ".ssl-images-amazon" +
                                                                   ".com/images/I" +
                                                                   "/51ct4ckpvDL.jpg"),
                                                         new Author("Gabriel García " +
                                                                    "Márquez"),
                                                         new ReleaseYear(1967),
                                                         new Rate(4.7), new Language(
                                                                 "Español"),
                                                         new Available(true)),
                                          ...
                                          new BookEntity(UUID.randomUUID(),
                                                         ...
                                                         new Rate(4.8), new Language(
                                                                 "Inglés"),
                                                         new Available(true)),
                                          new BookEntity(UUID.randomUUID(),
                                                         new BookName("El señor de los " +
                                                                      "anillos"),

package com.unir.webdev.books.infrastructur.persistence.mappers;
...
public class BookMapper {
    ...
    public static @NotNull Book fromDbToDomain(@NotNull BookEntity bookEntity) {
        return new Book(bookEntity.bookId(),
                        new com.unir.webdev.books.domain.valueObjects.BookName(bookEntity.bookName().bookName()),
                        new com.unir.webdev.books.domain.valueObjects.Isbn(bookEntity.isbn().isbn()),
                        new com.unir.webdev.books.domain.valueObjects.Image(bookEntity.image().url()),
    ...
    public static @NotNull BookEntity fromDomainToDb(@NotNull Book book) {
        return new BookEntity(book.bookId(),
                              new BookName(book.bookName().bookName()),
                              new Isbn(book.isbn().isbn()),
                              new Image(book.image().url()),
